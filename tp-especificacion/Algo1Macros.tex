...
\newcommand{\existe}[2]{(\exists \ #1)(#2)}   % Tomy 21/4
\newcommand{\paraTodo}[2]{(\forall \ #1)(#2)} % Tomy 21/4
...
\newcommand{\tupla}[2]{#1 \texttt{x} #2}

%listas
\newcommand{\TLista}[1]{\ensuremath{seq \langle #1\rangle}}
\newcommand{\lvacia}{\ensuremath{[\ ]}}
\newcommand{\lv}{\ensuremath{[\ ]}}
\newcommand{\longitud}[1]{\ensuremath{\mathsf{length}(#1)}}
...
\newcommand{\subind}[1]{\ensuremath{\mathrm{#1}}}
\newcommand{\division}{\ensuremath{\mathsf{div}}}
\newcommand{\modulo}{\ensuremath{\mathsf{mod}}}

%---------- Tomy --------
\newenvironment{especificacion}[2]{
    \newcommand{\encabezado}[2]{
        {\normalfont\ttfamily proc}%
        \ %
        {\normalfont\ttfamily ##1}%
        \ 
        % Parametros
    ...
    \newcommand{\pre}[1]{%
        {\normalfont\ttfamily Pre}\
        \{\ensuremath{##1}\}
        \par
    }
    \newcommand{\post}[1]{%
        {\normalfont\ttfamily Post}\
        \{\ensuremath{##1}\}
        \par
    }
    \newcommand{\postLargo}[1]{%
        {\normalfont\ttfamily Post}\
        \{ \vspace{0.5ex} \\  \ensuremath{##1} \par \}
        \par
    }
    \vspace{1ex}
    \noindent
